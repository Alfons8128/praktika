...
sigma_r50_1 = 30.27 * np.sqrt(4 * (900/5521623)**2 + (0.005/30.27)**2)
sigma_r50_2 = 172.38 * np.sqrt(4 * (900/5521623)**2 + (0.09/172.38)**2)
sigma_r100_1 = 60.35 * np.sqrt(4 * (900/5521623)**2 + (0.013/60.35)**2)
sigma_r100_2 = 354.4 * np.sqrt(4 * (900/5521623)**2 + (0.4/354.4)**2)
